  ...
  var Cuitimer = function(ele){
    ...
    Cuitimer.prototype = {
      ...
      getYMDHIS : function(endtime){
        ...
        else remain= {  m : "00", d : "00", h : "00", i : "00", s : "00"  };

        return " "+_this.addZero(remain.d)+" 天 : "+ _this.addZero(remain.h) +" 时 : "+ _this.addZero(remain.i) +" 分 : "+_this.addZero(remain.s)+" 秒";
      },
      ...
      makeText : function(config){
        ...
        _cb = config.callback,
        timeStr,
        hasTime = (new Date(_endtime) - new Date()) > 0;
        ...
        window.setInterval(function(){
          timeStr = _this.getYMDHIS(_endtime);
          hasTime = (new Date(_endtime) - new Date()) > 0 ;
